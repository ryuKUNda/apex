...
export class Player extends app.api.Adapter<app.api.Entity> {
  constructor(
    ...
    readonly  m_thirdPerson = new app.UInt8(app.entityOffsets.m_thirdPerson),
    readonly m_thirdPersonShoulderView = new app.UInt8(app.entityOffsets.m_thirdPersonShoulderView),
    ...
    super(new app.api.Entity(address, [localOrigin, teamNum, name, glowEnable, glowThroughWalls,m_thirdPersonShoulderView,m_thirdPerson, lifeState, viewAngles, bleedoutState]));
  }
